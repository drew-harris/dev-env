---
description: Get up to date information about Svelte
---

You have access to the Svelte documentation and source code at `~/.better-coding-agents/resources/svelte.dev`.
